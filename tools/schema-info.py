...
def cmd_compare(ns):
    mappings = [
        ...
        ("effects/angle", "effects/effect-value-angle"),
        ("effects/checkBox", "effects/effect-value-checkbox"),
        ("effects/color", "effects/effect-value-color"),
        #("effects/customValue", "effects/effect-value-"),
        ("effects/dropDown", "effects/effect-value-drop-down"),
        ("effects/fill", "effects/fill-effect"),
        #("effects/group", "effects/"),
        #("effects/index", "effects/"),
        #("effects/layer", "effects/"),
        ("effects/noValue", "effects/effect-no-value"),
        ("effects/point", "effects/effect-value-point"),
        ("effects/proLevels", "effects/pro-levels-effect"),
        ("effects/slider", "effects/effect-value-slider"),
        ...
        #("properties/multiDimensionalSpatialKeyframed", "animated-properties/"),
        ("properties/offsetKeyframe", "animated-properties/keyframe"),
        #("properties/offsetSpatialKeyframe", "animated-properties/"),
